...
btn.forEach(val =>{
    val.addEventListener("click", (e)=>{
        ...
        if(e.target.innerHTML=="employees"){
            ...
            <my-details logic="employee_3.6" text="3.6. Devuelve un listado que muestre solamente los empleados que no tienen un cliente asociado junto con los datos de la oficina donde trabajan."></my-details>
            `;
        }
