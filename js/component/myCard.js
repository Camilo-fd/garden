...
export class Mycard extends HTMLElement {
    ...
    // CONSULTAMULTITABLA #10
    async getNameClientsNotDeliveredOrderDesing() {
    ...
    // CONSULTAMULTITABLA #11
    async getGamasProductosrDesing() {
    ...
    // CONSULTAMULTITABLAEXTERNA #1
    async getClientsNotPayDesing() {
        let data = await getClientsNotPay()
        data.forEach(val => {
            this.shadowRoot.innerHTML += /*html*/ `
                <div class="report__card">
                    <div class="card__title">
    ...
    // CONSULTAMULTITABLAEXTERNA #4
    async getEmployeesNotOfficesDesing() {
        let data = await getEmployeesNotOffices()
            this.shadowRoot.innerHTML += /*html*/ `
                <div class="report__card">
                    <div class="card__title">
                        <div>CLIENTES</div>
                    ...
                    <div class="card__body">
                        <div class="body__marck">
                        <p><b>Empleados: </b>${"no hay empleados sin officinas associadas"}</p>
                        </div>
                    </div>
                </div>
            `
